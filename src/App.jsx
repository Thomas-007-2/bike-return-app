...
<div className="flex items-center space-x-4"> 
<div className={`flex items-center ${currentStep==='photos' ? 'text-primary-600' : 'text-gray-400'}`}> 
<div className={`w-7 h-7 rounded-full flex items-center justify-center text-sm font-medium ${
currentStep==='photos' ? 'bg-primary-600 text-white' : 'bg-gray-200 text-gray-600'
}`}> 
1 
</div> 
...
<div className={`flex items-center ${currentStep==='condition' ? 'text-primary-600' : 'text-gray-400'}`}> 
<div className={`w-7 h-7 rounded-full flex items-center justify-center text-sm font-medium ${
currentStep==='condition' ? 'bg-primary-600 text-white' : 'bg-gray-200 text-gray-600'
}`}> 
2 
</div> 
...
<PhotoUpload photos={photos} onPhotosSelected={handlePhotosSelected} /> 
{photos.length > 0 && ( 
...
{currentStep==='condition' && ( 
<ConditionForm onSubmit={handleFormSubmit} loading={loading} /> 
)} 
</main> 
