...
const getQuestions=()=> {
return [ 
{id: 'schaltung',question: i18n.t('gears'),type: 'problem_check',problemPlaceholder: i18n.t('gearsPlaceholder')},{id: 'bremsen',question: i18n.t('brakes'),type: 'problem_check',problemPlaceholder: i18n.t('brakesPlaceholder')},{id: 'sonstige_maengel',question: i18n.t('otherIssues'),type: 'problem_check',problemPlaceholder: i18n.t('otherIssuesPlaceholder')},{id: 'bemerkungen',question: i18n.t('additionalNotes'),type: 'text',placeholder: i18n.t('additionalNotesPlaceholder')} 
];
};
...
currentAnswer==='einwandfrei' ? 'border-green-500 bg-green-50' : 'border-gray-200 hover:border-gray-300'
}`}> 
<input 
type="radio" 
name={question.id} 
...
currentAnswer==='einwandfrei' ? 'border-green-500 bg-green-500' : 'border-gray-300'
}`}> 
...
<label className={`flex items-center p-4 border-2 rounded-lg cursor-pointer transition-all ${
currentAnswer==='probleme' ? 'border-orange-500 bg-orange-50' : 'border-gray-200 hover:border-gray-300'
}`}> 
<input 
type="radio" 
name={question.id} 
...
/> 
<div className={`flex-shrink-0 w-5 h-5 rounded-full border-2 mr-3 flex items-center justify-center ${
currentAnswer==='probleme' ? 'border-orange-500 bg-orange-500' : 'border-gray-300'
}`}> 
...
> 
<span> 
{isLastQuestion ? (loading ? i18n.t('sending') : i18n.t('submit')) : i18n.t('next')} 
</span> 
